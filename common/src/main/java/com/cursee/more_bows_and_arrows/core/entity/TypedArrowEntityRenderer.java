...
public class TypedArrowEntityRenderer extends ArrowRenderer<TypedArrowEntity> {
    ...
    public @NotNull ResourceLocation getTextureLocation(TypedArrowEntity tieredArrowEntity) {
        return ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/entity/arrow/" + tieredArrowEntity.getPickupItem().getDescriptionId().replace("item.more_bows_and_arrows.", "") + ".png");
    }
}
